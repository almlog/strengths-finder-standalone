...
const EMPLOYEES = {
  ...
  sheet1: [
    {
      id: '2260001', name: '徳川 家康', dept: 'DEPT_B04', position: '一般',
      scenario: '予兆対象（ペース高）',
    ...
    {
      id: '2260002', name: '豊臣 秀吉', dept: 'DEPT_B04', position: '一般',
    ...
    {
      id: '2260003', name: '武田 信玄', dept: 'DEPT_B05', position: '主任',
    ...
    {
      id: '2260004', name: '上杉 謙信', dept: 'DEPT_B05', position: '一般',
    ...
    {
      id: '2260005', name: '伊達 政宗', dept: 'DEPT_B06', position: '一般',
      scenario: '正常（残業少なめ）',
    ...
    {
      id: '2260006', name: '真田 幸村', dept: 'DEPT_B06', position: '一般',
...
// シート2: 8時スケジュール
const ws2 = generateSheet('CLIENT_A_日勤_800-1630～930-1800_1200', EMPLOYEES.sheet2);
XLSX.utils.book_append_sheet(wb, ws2, 'CLIENT_A_日勤_800-1630～930-1800_1200');
...
console.log('');
console.log('【シート2: CLIENT_A_日勤_800-1630～930-1800_1200（8時勤務）】');
