...
export type ImportStrategy = 'replace' | 'add' | 'merge' | 'cancel';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl">
        ...
        <div className="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
            <strong>既存データ:</strong> {existingCount}件のメンバー
          </p>
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
            <strong>インポートデータ:</strong> {newCount}件のメンバー
          </p>
          <p className="text-sm text-gray-700 dark:text-gray-300">
            <strong>重複:</strong> {duplicateIds.length}件のメンバー（社員番号が既存データと重複）
          </p>

          {duplicateIds.length > 0 && duplicateIds.length <= 10 && (
            <div className="mt-3 text-sm text-gray-600 dark:text-gray-400">
              <p className="font-medium mb-1">重複している社員番号:</p>
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  既存データはそのまま残し、重複していない新しいメンバーのみを追加します。
                  <br />
                  <span className="text-blue-600 dark:text-blue-400 font-medium">
                    👤 {newCount - duplicateIds.length}件の新規メンバーを追加
                  </span>
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  既存データを残し、重複しているメンバーは新しいデータで更新します。
                  <br />
