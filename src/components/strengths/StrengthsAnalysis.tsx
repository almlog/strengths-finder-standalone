    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <h4 className="text-md font-semibold mb-3">資質一覧</h4>
        ...
        {/* 選択された資質の詳細 */}
        <div className="bg-white rounded-lg shadow p-4">
          <h4 className="text-md font-semibold mb-3">資質の詳細</h4>
          
          {selectedStrength ? (
            <div>
              <div 
                className="border-l-4 p-4 rounded-r-lg bg-gray-50 mb-4"
                style={{ borderLeftColor: GROUP_COLORS[selectedStrength.group] }}
              >
                <div className="flex items-center mb-2">
                  <h5 className="font-medium text-lg">{selectedStrength.name}</h5>
                  <span 
                ...
                <p className="text-gray-700">{selectedStrength.description}</p>
              </div>
              
              <h5 className="font-medium mb-2">所有者一覧 ({selectedStrengthOwners.length}人)</h5>
                    ...
                    .map(owner => (
                      ...
                      >
                        <div>
                          ...
                          <div className="text-sm text-gray-500">部署: {owner.department}</div>
                        </div>
                        {owner.score > 0 && (
